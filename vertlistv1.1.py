#Python Script for printing list of names verticially (Replace the names with yours) V1.1
...
#new_list = input('Copy the list above and enter the updated list here: ')
